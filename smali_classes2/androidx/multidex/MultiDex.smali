...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/multidex/MultiDex;->SECONDARY_FOLDER_NAME:Ljava/lang/String;
...
.method private static checkValidZipFiles(Ljava/util/List;)Z
    ...
    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->verifyZipFile(Ljava/io/File;)Z
...
.method public static install(Landroid/content/Context;)V
    ...
    :cond_1
    sget-object v3, Landroidx/multidex/MultiDex;->installedApk:Ljava/util/Set;
    ...
    sget-object v5, Landroidx/multidex/MultiDex;->SECONDARY_FOLDER_NAME:Ljava/lang/String;

    invoke-direct {v1, v4, v5}, Ljava/io/File;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v4, 0x0

    invoke-static {p0, v2, v1, v4}, Landroidx/multidex/MultiDexExtractor;->load(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;

    move-result-object v4

    invoke-static {v4}, Landroidx/multidex/MultiDex;->checkValidZipFiles(Ljava/util/List;)Z

    move-result v5

    if-eqz v5, :cond_4

    invoke-static {v0, v1, v4}, Landroidx/multidex/MultiDex;->installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    ...
    invoke-static {p0}, Landroidx/multidex/MultiDex;->checkValidZipFiles(Ljava/util/List;)Z

    move-result v2

    if-eqz v2, :cond_5

    invoke-static {v0, v1, p0}, Landroidx/multidex/MultiDex;->installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
...
.method private static installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    ...
    invoke-static {p0, p2, p1}, Landroidx/multidex/MultiDex$V19;->access$000(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
