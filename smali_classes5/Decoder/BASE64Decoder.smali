...
.method static constructor <clinit>()V
    ...
    sput-object v0, LDecoder/BASE64Decoder;->pem_array:[C

    const/16 v0, 0x100

    new-array v0, v0, [B

    sput-object v0, LDecoder/BASE64Decoder;->pem_convert_array:[B
...
.method protected decodeAtom(Ljava/io/PushbackInputStream;Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {p0, p1, v3, v5, v1}, LDecoder/CharacterDecoder;->readFully(Ljava/io/InputStream;[BII)I
    ...
    :goto_0
    sget-object v6, LDecoder/BASE64Decoder;->pem_convert_array:[B

    iget-object v7, p0, LDecoder/BASE64Decoder;->decode_buffer:[B
    ...
    :cond_b
    new-instance p1, LDecoder/CEFormatException;

    const-string p2, "BASE64Decoder: Not enough bytes for an atom."

    invoke-direct {p1, p2}, LDecoder/CEFormatException;-><init>(Ljava/lang/String;)V
