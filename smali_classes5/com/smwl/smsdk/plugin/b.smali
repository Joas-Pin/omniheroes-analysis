.class public Lcom/smwl/smsdk/plugin/b;
.super Ljava/lang/Object;


# static fields
.field private static volatile b:Lcom/smwl/smsdk/plugin/b;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/smwl/smsdk/plugin/b;->a:Ljava/security/KeyStore;
...
.method public static a()Lcom/smwl/smsdk/plugin/b;
    .locals 2

    sget-object v0, Lcom/smwl/smsdk/plugin/b;->b:Lcom/smwl/smsdk/plugin/b;

    if-nez v0, :cond_1

    const-class v0, Lcom/smwl/smsdk/plugin/b;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/smwl/smsdk/plugin/b;->b:Lcom/smwl/smsdk/plugin/b;

    if-nez v1, :cond_0

    new-instance v1, Lcom/smwl/smsdk/plugin/b;

    invoke-direct {v1}, Lcom/smwl/smsdk/plugin/b;-><init>()V

    sput-object v1, Lcom/smwl/smsdk/plugin/b;->b:Lcom/smwl/smsdk/plugin/b;
...
.method private a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/smwl/smsdk/plugin/b;->a:Ljava/security/KeyStore;
...
.method public static synthetic a(Lcom/smwl/smsdk/plugin/b;Landroid/content/Context;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/smwl/smsdk/plugin/b;->a(Landroid/content/Context;Ljava/lang/String;)V
...
.method public b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/smwl/smsdk/plugin/thread/c;->c()Lcom/smwl/smsdk/plugin/thread/d;

    move-result-object v0

    new-instance v1, Lcom/smwl/smsdk/plugin/b$a;

    invoke-direct {v1, p0, p1, p2}, Lcom/smwl/smsdk/plugin/b$a;-><init>(Lcom/smwl/smsdk/plugin/b;Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Lcom/smwl/smsdk/plugin/thread/d;->a(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
