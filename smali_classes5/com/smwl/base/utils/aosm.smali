.class public Lcom/smwl/base/utils/aosm;
.super Ljava/lang/Object;
.source ""


# static fields
.field private static acsm:Lcom/smwl/base/utils/aosm;


# instance fields
.field private aasm:Ljava/lang/String;

.field private absm:Ljava/security/KeyStore;
...
.method private constructor <init>()V
    ...
    iput v0, p0, Lcom/smwl/base/utils/aosm;->asm:I

    const-string v0, "CN=MyKey, O=Android Authority"

    iput-object v0, p0, Lcom/smwl/base/utils/aosm;->aasm:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/smwl/base/utils/aosm;->absm:Ljava/security/KeyStore;
...
.method private aasm(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/smwl/base/utils/aosm;->absm:Ljava/security/KeyStore;
    ...
    iget-object v2, p0, Lcom/smwl/base/utils/aosm;->aasm:Ljava/lang/String;
...
.method public static acsm()Lcom/smwl/base/utils/aosm;
    .locals 2

    sget-object v0, Lcom/smwl/base/utils/aosm;->acsm:Lcom/smwl/base/utils/aosm;

    if-nez v0, :cond_1

    const-class v0, Lcom/smwl/base/utils/aosm;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/smwl/base/utils/aosm;->acsm:Lcom/smwl/base/utils/aosm;

    if-nez v1, :cond_0

    new-instance v1, Lcom/smwl/base/utils/aosm;

    invoke-direct {v1}, Lcom/smwl/base/utils/aosm;-><init>()V

    sput-object v1, Lcom/smwl/base/utils/aosm;->acsm:Lcom/smwl/base/utils/aosm;
...
.method static synthetic asm(Lcom/smwl/base/utils/aosm;Landroid/content/Context;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/smwl/base/utils/aosm;->aasm(Landroid/content/Context;Ljava/lang/String;)V
...
.method public absm(Landroid/content/Context;Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/smwl/base/utils/aosm$asm;

    invoke-direct {v1, p0, p1, p2}, Lcom/smwl/base/utils/aosm$asm;-><init>(Lcom/smwl/base/utils/aosm;Landroid/content/Context;Ljava/lang/String;)V
