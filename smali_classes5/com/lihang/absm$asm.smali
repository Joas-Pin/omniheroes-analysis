...
.method constructor <init>(Landroid/view/View;Landroid/graphics/drawable/Drawable;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/lihang/absm$asm;->aasm:Landroid/view/View;

    iput-object p2, p0, Lcom/lihang/absm$asm;->absm:Landroid/graphics/drawable/Drawable;

    iput-object p3, p0, Lcom/lihang/absm$asm;->acsm:Ljava/lang/String;
...
.method public onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    iget-object p1, p0, Lcom/lihang/absm$asm;->aasm:Landroid/view/View;
    ...
    invoke-virtual {p1}, Lcom/bumptech/glide/alsm;->ausm()Lcom/bumptech/glide/aksm;

    move-result-object p1

    iget-object p2, p0, Lcom/lihang/absm$asm;->absm:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1, p2}, Lcom/bumptech/glide/aksm;->eosm(Landroid/graphics/drawable/Drawable;)Lcom/bumptech/glide/aksm;
    ...
    iget-object p2, p0, Lcom/lihang/absm$asm;->aasm:Landroid/view/View;

    invoke-virtual {p2}, Landroid/view/View;->getMeasuredWidth()I

    move-result p2

    iget-object p3, p0, Lcom/lihang/absm$asm;->aasm:Landroid/view/View;
    ...
    new-instance p2, Lcom/lihang/absm$asm$asm;

    invoke-direct {p2, p0}, Lcom/lihang/absm$asm$asm;-><init>(Lcom/lihang/absm$asm;)V
