...
.method private findMatchingRule([Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v6, Lokhttp3/internal/absm;->aism:Ljava/nio/charset/Charset;
...
.method private readTheList()V
    ...
    :cond_0
    new-instance v1, Lokio/aksm;

    invoke-static {v0}, Lokio/aosm;->aksm(Ljava/io/InputStream;)Lokio/azsm;

    move-result-object v0

    invoke-direct {v1, v0}, Lokio/aksm;-><init>(Lokio/azsm;)V
    ...
    invoke-interface {v0, v2}, Lokio/adsm;->readFully([B)V
    :try_end_0
...
.method private readTheListUninterruptibly()V
    ...
    invoke-virtual {v2, v3, v4, v1}, Lokhttp3/internal/platform/aesm;->aqsm(ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
