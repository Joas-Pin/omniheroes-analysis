...
.method public static synthetic aasm(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat;)V
    .locals 0
...
.method public static synthetic absm(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public static synthetic acsm(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public static synthetic asm(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;I)V
    .locals 0
...
.method public onGpsStatusChanged(I)V
    ...
    new-instance v1, Landroidx/core/location/ahsm;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/ahsm;-><init>(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat;)V
    ...
    new-instance v1, Landroidx/core/location/agsm;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/agsm;-><init>(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;I)V
    ...
    :cond_3
    new-instance p1, Landroidx/core/location/afsm;

    invoke-direct {p1, p0, v0}, Landroidx/core/location/afsm;-><init>(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;)V

    goto :goto_1

    :cond_4
    new-instance p1, Landroidx/core/location/aesm;

    invoke-direct {p1, p0, v0}, Landroidx/core/location/aesm;-><init>(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;)V
