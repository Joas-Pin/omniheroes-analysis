...
.method public static synthetic aasm(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
    .locals 0
...
.method public static synthetic absm(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;I)V
    .locals 0
...
.method public static synthetic acsm(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public static synthetic asm(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public onFirstFix(I)V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/assm;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/assm;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;I)V
...
.method public onSatelliteStatusChanged(Landroid/location/GnssStatus;)V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/atsm;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/atsm;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
...
.method public onStarted()V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/arsm;

    invoke-direct {v1, p0, v0}, Landroidx/core/location/arsm;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
...
.method public onStopped()V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/aqsm;

    invoke-direct {v1, p0, v0}, Landroidx/core/location/aqsm;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
