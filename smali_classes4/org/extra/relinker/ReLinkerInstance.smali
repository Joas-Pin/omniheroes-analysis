...
.method private loadLibraryInternal(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Lorg/extra/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v3, p2}, Lorg/extra/relinker/ReLinker$LibraryLoader;->loadLibrary(Ljava/lang/String;)V

    iget-object v3, p0, Lorg/extra/relinker/ReLinkerInstance;->loadedLibraries:Ljava/util/Set;
    ...
    invoke-virtual {p0, v3, v4}, Lorg/extra/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-virtual {p0, v4, v3}, Lorg/extra/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-boolean v4, p0, Lorg/extra/relinker/ReLinkerInstance;->force:Z
    ...
    invoke-virtual {p0, v5, v4}, Lorg/extra/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Lorg/extra/relinker/ReLinkerInstance;->libraryInstaller:Lorg/extra/relinker/ReLinker$LibraryInstaller;

    iget-object v4, p0, Lorg/extra/relinker/ReLinkerInstance;->libraryLoader:Lorg/extra/relinker/ReLinker$LibraryLoader;

    invoke-interface {v4}, Lorg/extra/relinker/ReLinker$LibraryLoader;->supportedAbis()[Ljava/lang/String;

    move-result-object v7

    iget-object v4, p0, Lorg/extra/relinker/ReLinkerInstance;->libraryLoader:Lorg/extra/relinker/ReLinker$LibraryLoader;

    invoke-interface {v4, p2}, Lorg/extra/relinker/ReLinker$LibraryLoader;->mapLibraryName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface/range {v5 .. v10}, Lorg/extra/relinker/ReLinker$LibraryInstaller;->installLibrary(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Lorg/extra/relinker/ReLinkerInstance;)V

    :cond_3
    :try_start_1
    iget-boolean v4, p0, Lorg/extra/relinker/ReLinkerInstance;->recursive:Z
    :try_end_1
    ...
    :try_start_2
    new-instance v5, Lorg/extra/relinker/elf/ElfParser;

    invoke-direct {v5, v3}, Lorg/extra/relinker/elf/ElfParser;-><init>(Ljava/io/File;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-virtual {v5}, Lorg/extra/relinker/elf/ElfParser;->parseNeededDependencies()Ljava/util/List;
    ...
    :try_start_4
    invoke-virtual {v5}, Lorg/extra/relinker/elf/ElfParser;->close()V
    ...
    iget-object v6, p0, Lorg/extra/relinker/ReLinkerInstance;->libraryLoader:Lorg/extra/relinker/ReLinker$LibraryLoader;

    invoke-interface {v6, v5}, Lorg/extra/relinker/ReLinker$LibraryLoader;->unmapLibraryName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {p0, p1, v5}, Lorg/extra/relinker/ReLinkerInstance;->loadLibrary(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {v4}, Lorg/extra/relinker/elf/ElfParser;->close()V
    ...
    invoke-interface {p1, v3}, Lorg/extra/relinker/ReLinker$LibraryLoader;->loadPath(Ljava/lang/String;)V
