...
.method private static buildTrieRecursive(JLorg/cocos2dx/okio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    :cond_10
    new-instance v13, Lorg/cocos2dx/okio/Buffer;

    invoke-direct {v13}, Lorg/cocos2dx/okio/Buffer;-><init>()V

    invoke-static {v13}, Lorg/cocos2dx/okio/Options;->intCount(Lorg/cocos2dx/okio/Buffer;)I
    ...
    invoke-virtual {v13}, Lorg/cocos2dx/okio/Buffer;->size()J

    move-result-wide v1

    invoke-virtual {v0, v13, v1, v2}, Lorg/cocos2dx/okio/Buffer;->write(Lorg/cocos2dx/okio/Buffer;J)V
