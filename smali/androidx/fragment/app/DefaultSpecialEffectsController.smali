...
.method private startTransitions(Ljava/util/List;ZLandroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/SpecialEffectsController$Operation;)Ljava/util/Map;
    ...
    .end local v34    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .local v14, "lastInEpicenterRect":Landroid/graphics/Rect;
    ...
    .line 588
    .end local v14    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .restart local v34    # "lastInEpicenterRect":Landroid/graphics/Rect;
    :cond_26
    move-object/from16 v14, v34

    .end local v34    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .restart local v14    # "lastInEpicenterRect":Landroid/graphics/Rect;
    move-object/from16 v13, v31
    ...
    .end local v14    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .local v8, "lastInEpicenterRect":Landroid/graphics/Rect;
    move-object v14, v4
...
.method executeOperations(Ljava/util/List;Z)V
    ...
    .line 63
    .local v5, "currentState":Landroidx/fragment/app/SpecialEffectsController$Operation$State;
    ...
    .end local v5    # "currentState":Landroidx/fragment/app/SpecialEffectsController$Operation$State;
    :cond_2
    :goto_1
    goto :goto_0
    ...
    .line 85
    .local v3, "transitions":Ljava/util/List;, "Ljava/util/List<Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;>;"
    ...
    .line 90
    .local v8, "animCancellationSignal":Landroidx/core/os/CancellationSignal;
    invoke-virtual {v7, v8}, Landroidx/fragment/app/SpecialEffectsController$Operation;->markStartedSpecialEffect(Landroidx/core/os/CancellationSignal;)V
    ...
    invoke-virtual {v7, v9}, Landroidx/fragment/app/SpecialEffectsController$Operation;->markStartedSpecialEffect(Landroidx/core/os/CancellationSignal;)V
    ...
    .end local v8    # "animCancellationSignal":Landroidx/core/os/CancellationSignal;
    ...
    invoke-interface {v6, v4}, Ljava/util/Map;->containsValue(Ljava/lang/Object;)Z

    move-result v4

    .line 120
    .local v4, "startedAnyTransition":Z
    invoke-direct {p0, v2, v5, v4, v6}, Landroidx/fragment/app/DefaultSpecialEffectsController;->startAnimations(Ljava/util/List;Ljava/util/List;ZLjava/util/Map;)V
