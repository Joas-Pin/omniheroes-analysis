...
.method public declared-synchronized process(Lio/sentry/protocol/SentryTransaction;Lio/sentry/Hint;)Lio/sentry/protocol/SentryTransaction;
    ...
    invoke-virtual {p2}, Lio/sentry/protocol/Contexts;->getApp()Lio/sentry/protocol/App;

    move-result-object p2

    if-nez p2, :cond_3

    new-instance p2, Lio/sentry/protocol/App;

    invoke-direct {p2}, Lio/sentry/protocol/App;-><init>()V

    invoke-virtual {p1}, Lio/sentry/protocol/SentryTransaction;->getContexts()Lio/sentry/protocol/Contexts;

    move-result-object v0

    invoke-virtual {v0, p2}, Lio/sentry/protocol/Contexts;->setApp(Lio/sentry/protocol/App;)V
    ...
    :goto_1
    invoke-virtual {p2, v0}, Lio/sentry/protocol/App;->setStartType(Ljava/lang/String;)V
