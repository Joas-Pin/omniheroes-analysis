...
.method private static synthetic $values()[Lio/sentry/MeasurementUnit$Duration;
    ...
    sget-object v2, Lio/sentry/MeasurementUnit$Duration;->MICROSECOND:Lio/sentry/MeasurementUnit$Duration;
    ...
    sget-object v2, Lio/sentry/MeasurementUnit$Duration;->SECOND:Lio/sentry/MeasurementUnit$Duration;

    aput-object v2, v0, v1

    const/4 v1, 0x4

    sget-object v2, Lio/sentry/MeasurementUnit$Duration;->MINUTE:Lio/sentry/MeasurementUnit$Duration;

    aput-object v2, v0, v1

    const/4 v1, 0x5

    sget-object v2, Lio/sentry/MeasurementUnit$Duration;->HOUR:Lio/sentry/MeasurementUnit$Duration;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, Lio/sentry/MeasurementUnit$Duration;->DAY:Lio/sentry/MeasurementUnit$Duration;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, Lio/sentry/MeasurementUnit$Duration;->WEEK:Lio/sentry/MeasurementUnit$Duration;
